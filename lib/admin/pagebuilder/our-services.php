		...
		if ($services_query->have_posts() ) {
			...
			while ($services_query->have_posts() ) {
				...
				if( get_field( 'services_button' ) == 'yes' ) {
					$output .= '<h4><a href="' . the_field( 'service_link' ) . '" title="' . esc_html( get_the_title() ) . '">' . esc_html( get_the_title() ) . '</a></h4>';
					$output .= '<p>' . esc_html( get_the_content() ) . '</p>';
					$output .= '<div class="content-button">';
					$output .= '<a href="' . the_field( 'service_link' ) . '" target="_self" title="' . esc_html( get_the_title() ) . '">Read more</a>';
					$output .= '</div>';
				} else {
