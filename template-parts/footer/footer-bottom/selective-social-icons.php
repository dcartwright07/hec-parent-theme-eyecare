<?php
	...
	$wc_selected_icons = get_theme_mod('wc_footer_bottom_selicons');
	
	if(empty($wc_selected_icons)) { 
		//setting Default Values
		$wc_selected_icons = 'wc_socialoptions_fb_field,wc_socialoptions_tw_field,wc_socialoptions_lin_field,wc_socialoptions_in_field,wc_socialoptions_gp_field';
	}
?>
...
<ul class="menu social">
	<?php
		...
		$default_phone 		= "123-123-1234"; // Dummy Placeholder text Escaped on call
		$default_address 	= "248 Texas , 4353"; // Dummy Placeholder text Escaped on call
		$default_email 		= "youremail@site.com"; // Dummy Placeholder text Escaped on call
		$default_timings 	= esc_html__("Monday - Friday : 09:00-17:00", "eyecare"); // Dummy Placeholder text Escaped on call
